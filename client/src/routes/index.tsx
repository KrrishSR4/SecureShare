...
function Landing() {
  ...
  return (
    <div
      id="top"
      className="relative min-h-screen bg-background text-foreground grain overflow-hidden"
    >
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <p className="hero-description opacity-0 mt-6 max-w-xl text-lg font-kelly text-muted-foreground text-balance md:text-2xl">
      ...
      <Section
        ...
        title={
          <>
            Once a file leaves your <span className="italic text-muted-foreground">walls</span>,
            it's gone.
          </>
        }
      ...
      <Section
        ...
        title={
          <>
            Share sensitive data <span className="italic text-muted-foreground">in six moves</span>.
          </>
        }
      ...
      <Section
        ...
        title={
          <>
            Enforcement at every <span className="italic text-muted-foreground">stage</span>.
          </>
        }
      ...
      <Section
        ...
        title={
          <>
            Built for the teams that <span className="italic text-muted-foreground">cannot</span>{" "}
            afford a leak.
          </>
        }
      ...
      <Section
        ...
        title={
          <>
            Six layers. <span className="italic text-muted-foreground">One</span> guarantee.
          </>
        }
